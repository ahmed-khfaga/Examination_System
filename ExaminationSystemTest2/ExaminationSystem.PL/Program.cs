    ...
    public class Program
    {
        public static void Main(string[] args)
        {
           ...
           options.UseSqlServer(builder.Configuration.GetConnectionString("DefaultConnection")));
            ...
            #region Service for Dependance Injection
            builder.Services.AddScoped<IDepartmentRepositories, DepartmentRepositories>();
            builder.Services.AddScoped<IInstructorRepositories, InstructorRepositories>();
            builder.Services.AddScoped<ICourseRepositories, CourseRepositories>();
            builder.Services.AddScoped<IExamModelRepositories, ExamModelRepositories>();
            builder.Services.AddScoped<IQuestionBankRepositories, QuestionBankRepositories>();
